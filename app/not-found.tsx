  ...
  return (
    <main style={{ padding: '120px 0 160px' }}>
      <div className="wrap-read text-center">
        <p
          className="font-mono text-ink-soft uppercase mb-8"
        ...
        <p className="text-ink-muted mb-10" style={{ fontSize: '16px' }}>
          這個頁面不存在，或已經被移動了。
        </p>
        <Link
          href="/"
          className="font-mono text-ink uppercase border-b border-ink pb-0.5 hover:text-accent hover:border-accent transition-colors"
