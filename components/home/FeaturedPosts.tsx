          ...
          {posts.map((post, i) => (
            ...
            >
              ...
              <div>
                ...
                {post.excerpt && (
                  <p
                    className="text-body-muted hidden md:block"
              ...
              {/* <span
                className="font-mono text-body-soft hidden md:block"
              ...
              <span
                className="font-mono text-body-soft text-right hidden sm:block"
