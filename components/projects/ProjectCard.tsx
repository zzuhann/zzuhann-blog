...
export default function ProjectCard({ project }: { project: Project }) {
  return (
    <Link
      ...
      className="group bg-surface border border-border flex flex-col gap-4 cursor-pointer hover:shadow-[0_8px_24px_rgba(0,0,0,.06)] hover:-translate-y-0.5 hover:border-body-soft transition-all no-underline"
    ...
    >
      ...
      <div>
        ...
        {project.nameZh && (
          <p
            className="text-body-muted mt-1 mb-0"
            style={{
